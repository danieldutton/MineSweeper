...
namespace MineSweeper.UnitTests.GameModeFactory
{
    [TestFixture]
    public class GameModeFactory_Should
    {
        private MineSweeper.GameModeFactory.GameModeFactory _sut;
        ...
        public void Init()
        {
            _sut = new MineSweeper.GameModeFactory.GameModeFactory();
        }
